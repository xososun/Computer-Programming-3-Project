...
public class LibrarianManagementSystemGUI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LibrarianManagementSystemGUI window = new LibrarianManagementSystemGUI();
	 ...
	 */
	public LibrarianManagementSystemGUI() {
		initialize();
	}
	...
	private void initialize() {
		...
		frmLibrary.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 12));
		frmLibrary.setTitle("Authorized Library Management System");
		...
		JButton btnNewButton_1_1 = new JButton("Archive");
		btnNewButton_1_1.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 11));
		btnNewButton_1_1.setBounds(472, 164, 110, 25);
